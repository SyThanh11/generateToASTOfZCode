...
def main(argv):
    if len(argv) < 1:
        ...
        subprocess.run(["C:/Program Files/Java/jdk-11/bin/java.exe", "-jar", ANTLR_JAR, "-o", "../target",
        ...
        process1 = subprocess.Popen(
            ["C:/Program Files/Java/jdk-11/bin/java.exe", "-jar", ANTLR_JAR,
        ...
        if not os.path.isdir(TARGET_DIR + "/" + GENERATE_DIR):
            subprocess.run(["C:/Program Files/Java/jdk-11/bin/java.exe", "-jar", ANTLR_JAR, "-o", GENERATE_DIR,
                           "-no-listener", "-visitor", "main/zcode/parser/ZCode.g4"])
